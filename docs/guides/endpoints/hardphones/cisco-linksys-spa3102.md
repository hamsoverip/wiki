...
The Linksys SPA 3102 is an ATA allowing the user to use a POTS phone to access a VoIP service.

## Configuration

Go to the ATA's admin page. The default URL is `http://sipuraspa/admin`, but you may have to replace `sipuraspa` with the IP address that the device obtained from your router in your network.
